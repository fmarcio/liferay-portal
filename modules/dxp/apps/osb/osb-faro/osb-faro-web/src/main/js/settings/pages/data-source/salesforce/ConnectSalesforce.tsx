...
import {ConnectSalesForceBody} from './ConnectSalesforceBody';
...
const ConnectSalesForceStep = ({onNext, onPrev}) => {
	...
	return (
		...
		>
			<ConnectSalesForceBody inputs={inputs} onInputsChange={setInputs} />

			<ButtonGroup
				nextButtonLabel={Liferay.Language.get('connect')}
				onCancel={onPrev}
